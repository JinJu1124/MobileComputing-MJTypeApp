...
public class question_2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView progress_text = (TextView)findViewById(R.id.progress_text2);
        ...
        radiogroup1.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(RadioGroup radioGroup, int i) {
                ...
                if (response1==1&&response2==2&&response3==3){
                    ...
                    progress_text.setText("Go Next Stage!");}
            }
        });
        ...
        nextButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(response1==1&&response2==2&&response3==3) {
                    Intent intent_1 = new Intent(getApplicationContext(), question_3.class);
                    cul();
                    intent_1.putExtra("name", user_name);
                    intent_1.putExtra("gender", user_gender);
                    intent_1.putExtra("number", good + number);
                    intent_1.putExtra("number2", bad+number2);
                    startActivity(intent_1);
                    finish();
                    //모든 질문에 응답을 안했을 경우 대화상자 불러옴
                } else if(response1==0||response2==0||response3==0){
                    AlertDialog.Builder dlg = new AlertDialog.Builder(question_2.this);
