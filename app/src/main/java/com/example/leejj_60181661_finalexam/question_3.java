...
public class question_3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView progress_text = (TextView)findViewById(R.id.progress_text3);
        ...
        radiogroup1.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(RadioGroup radioGroup, int i) {
                ...
                if (response1==1&&response2==2&&response3==3){
                    ...
                    progress_text.setText("Let's see Result!");}
            }
        });
        ...
        nextButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(response1==1&&response2==2&&response3==3) {
                    Intent intent_1 = new Intent(getApplicationContext(), result.class);
                    cul();
                    ...
                    AlertDialog.Builder dlg = new AlertDialog.Builder(question_3.this);
